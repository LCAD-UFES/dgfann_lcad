...
The first dataset ([dataset2: steering](new_datasets/steering-20140509.tar.bz2), [dataset2: velocity](new_datasets/velocity-20140509.tar.bz2)) was captured in the same parking lot used in the experiments presented in [1], while the second dataset ([dataset1: steering](new_datasets/steering-20140802.tar.bz2), [dataset1: velocity](new_datasets/velocity-20140802.tar.bz2)) was captured in the beltway of the *Universidade Federal do Espírito Santo* (UFES). They were collected respectively at 2014/05/09 and 2014/08/02. In the beltway dataset, the robotic car performed significantly different maneuvers in relation to the parking lot datasets. These new maneuvers represent a constant challenge to the neural net estimation
